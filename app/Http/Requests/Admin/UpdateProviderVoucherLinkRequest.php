...
class UpdateProviderVoucherLinkRequest extends BaseApiRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'provider' => ['sometimes', 'in:uber,ubereats'],
            'link_url' => ['sometimes', 'url', 'max:4000'],
            'offer_type' => ['sometimes', 'in:food,ride,dual_choice'],
