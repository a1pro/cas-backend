...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $venues = [
            ...
            [
                'name' => 'Ancoats Coffee House',
                'category' => 'cafe',
                'city' => 'Manchester',
                'postcode' => 'M4 6AG',
                'address' => '6 Blossom Street, Manchester',
                'latitude' => 53.484400,
                'longitude' => -2.231700,
                'description' => 'Cafe with pastries, coffee, and light food offers.',
                'offer_value' => 4,
                'offer_type' => 'food',
                'ride_trip_type' => null,
                'minimum_order' => 12,
            ...
            [
                'name' => 'Northern Takeaway Kitchen',
                'category' => 'takeaway',
                'city' => 'Manchester',
                'postcode' => 'M1 2AB',
                'address' => '45 Oldham Street, Manchester',
                'latitude' => 53.482500,
                'longitude' => -2.235800,
                'description' => 'Takeaway spot for late food orders and collection.',
                'offer_value' => 5,
                'offer_type' => 'food',
                'ride_trip_type' => null,
                'minimum_order' => 18,
